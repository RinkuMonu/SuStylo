...
function BlogsDetails() {
            ...
            <div className="row">
              <div className="col-md-8 col-sm-12 mb-3">
                ...
                <div className="blog-main_content">
                  ...
                  <p>{blog.content || 'Lorem ipsum labore aliqua tempor quis amet dolor duis reprehenderit exercitation in mollit esse anim reprehenderit velit voluptate consequat nisi in occaecat veniam enim officia sit et excepteur ullamco veniam quis aute voluptate tempor officia qui.'.repeat(3)}</p>
                </div>
  ...
  {submitSuccess && (
    <div className="alert alert-success">Comment submitted successfully!</div>
  )}

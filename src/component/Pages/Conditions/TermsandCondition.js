                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <div className="clearfix companydetails">
                                ...
                                <p className="mb-3"> SuStylo Salon is an online platform providing at-home and in-salon grooming services (collectively referred to as “Services”). It is owned and operated by SuStylo Private Limited, a company registered under the Companies Act, 2013.
                                </p>
                                ...
                                <p>SuStylo reserves the right to modify these terms at any time. Any changes will take effect immediately upon being posted on the platform. Continued use of the services implies acceptance of the revised terms.
                                </p>
                        ...
                        <div className="col-md-12">
                            ...
                            <p style={{ fontSize: "16px" }}>For Post-Pay Options, Proceed To Complete The Booking Merely By Paying A Nominal Booking Fee. The Service Fee, As Reflected On The Account At The Time Of Booking, Shall Be Paid After The Services Are Completed. Complete The Payment Process To Secure Your Booking. Once You Have Booked A Service, SuStylo Shall Assign The Service Professional To You Within 2 (“Two”) Hours From The Receipt Of Your Booking Request, If Such Request Is Made During Regular Working Hours. If The Booking Request Is Made After Working Hours, SuStylo Will Assign The Service Professional On The Following Working Day. The Service Professional Shall Be Assigned Subject To Various Factors Such As Their Availability, The Nature Of The Service Requested, Their Expertise, And The Proximity Of Your Location. SuStylo Reserves The Right To Substitute And Assign A New Service Professional In Case Of Unforeseen Circumstances Or If The Initially Assigned Professional Becomes Unavailable, Provided That The Substitution Is Available And Accepted By The Customer. Upon Successful Booking, You Will Receive A Confirmation Message With The Details Of Your Appointment On Your Registered Email Address And Mobile Number. The Assigned Service Professional Will Arrive At The Specified Address At The Scheduled Time And Provide The Requested Services, Whether It Be At Your Home For ‘Salon-At-Homeʼ Services Or At The Chosen Salon For ‘At-Salonʼ Services.</p>
                        </div>
                        <hr className="mt-5" />
                        <div className="col-md-12">
                            <div className="gallery_heading text-left mb-2">
                            ...
                            <div className="de-separator" style={{ backgroundSize: "100%", backgroundRepeat: "no-repeat", margin: "0px", marginTop: "16px", marginBottom: "25px" }}></div>
                            <p style={{ fontSize: "16px" }}>If You Have Already Availed The Services Of The Service Professional Through Our Platform, You Will Have The Option To Re-Book The Same Service Professional For Future Appointments In The Following Manner: Add The Desired Services In Your Cart As Per The Process Specified Under Clause 5.2.1.(I) To (V) Above. Select The Preferred Professional And/Or Salon, As Applicable, From The List Of Professionals And Salon, For The Particular Service. In Case You Do Not Want The Same Service Professional, You Will Have The Option To Request For A New Service Professional As Well. Proceed With Requesting The Booking. Once You Have Booked A Service, SuStylo Shall Assign The Preferred Service Professional Within 2 Hours Of The Receipt Of Your Booking Request, If Such Request Is Made During Regular Working Hours. If The Booking Request Is Made After Working Hours, SuStylo Will Assign The Service Professional On The Following Working Day. The Preferred Service Professional Shall Be Assigned Subject To Their Availability, The Requested Appointment Slot, And The Proximity Of Your Location. If The Slot Of Your Preferred Service Professional Is Not Available, Please Proceed With Placing The Booking Request, And SuStylo Will Try To Assign You The Best Available Service Professional Within 2 Hours Of The Receipt Of Your Booking Request, If Such Request Is Made During Regular Working Hours. If The Booking Request Is Made After Working Hours, SuStylo Will Assign The Service Professional On The Following Working Day. Please Be Assured That All Our Service Professionals Are Trained To Deliver A High-Quality Experience.</p>
                            <p style={{ fontSize: "16px" }}>Upon Successful Booking, You Will Receive A Confirmation Message With The Details Of Your Appointment On Your Registered Email Address And Mobile Number. The Assigned Service Professional Will Arrive At The Specified Address At The Scheduled Time And Provide The Requested Services, Whether It Be At Your Home For ‘Salon-At-Homeʼ Services Or At The Chosen Salon For ‘At-Salonʼ Services.</p>
                            <p style={{ fontSize: "16px" }}>Substitution: In Case Of The Unavailability Of, Or Cancellation By The Assigned Service Professional, Due To Any Reason Whatsoever, SuStylo Will Offer You A Substitute Of The Service Professional From Among Our Registered Service Professionals, Provided That The Substitution Is Available And Accepted By The Customer.</p>
                        </div>
                        <hr className="mt-5" />
                        <div className="col-md-12">
                            <div className="gallery_heading text-left mb-2">
                            ...
                            <div className="de-separator" style={{ backgroundSize: "100%", backgroundRepeat: "no-repeat", margin: "0px", marginTop: "16px", marginBottom: "25px" }}></div>
                            <p style={{ fontSize: '16px' }}>Pricing: SuStylo Adheres To A Transparent Pricing Policy, And The Prices Displayed On The Platform Alongside Each Of The Listed Services Reflect The True Cost Of Such Services. SuStylo Reserves The Right To Modify The Pricing Of The Services Offered Through The Platform, At Its Sole Discretion. However, Any Changes In The Pricing Will Not Affect Confirmed Bookings Made Before The Revised Pricing Is Published On The Platform. Payment Of Service Fee And Transaction Fee: In Lieu Of The Services Availed By You Through The Platform, You Agree To Pay The Service Fee To SuStylo, As Notified To You At The Time Of Booking. Payment Of Service Fee For ‘Salon-At-Homeʼ Services Shall Be Prepaid. Payment Of Service Fee For ‘At-Salonʼ Services Can Be Made Either As Prepaid Or Postpaid, As Per Your Preference And The Options Provided By SuStylo.</p>
                            <p style={{ fontSize: '16px' }}>For Prepaid Payments, You Agree To Pay The Service Fee (Inclusive Of The Transaction Fee) Using The Designated Payment Methods Facilitated By SuStylo, Which May Include But Are Not Limited To, Credit Cards, Debit Cards, Net Banking, Wallets (Such As Google Pay), UPI (Unified Payments Interface), And Other Third-Party Payment Processors Approved By SuStylo (Collectively, “Payment Processors”).
                            </p>
                            <p style={{ fontSize: '16px' }}>For Postpaid Payments, You Agree To Pay The Service Fee (Exclusive Of The Transaction Fee) Directly To The Service Professional, Upon Completion Of The Booked Services, Using The Designated Payment Methods. SuStylo May Facilitate Payment By Generating A QR Code Reflecting The Requisite Amount For The Client To Scan And Make The Payment Electronically. Alternatively, The Client May Opt To Pay The Service Fee In Cash Directly To The Service Professional.</p>
                        </div>
                        <hr className="mt-5" />
                        <div className="col-md-12">
                            <div className="gallery_heading text-left mb-2">
                            ...
                            <div className="de-separator" style={{ backgroundSize: "100%", backgroundRepeat: "no-repeat", margin: "0px", marginTop: "16px", marginBottom: "25px" }}></div>
                            <p style={{ fontSize: "16px" }}>Cancellation Of Booking By User: The User Shall Have The Right To Cancel The Bookings At Any Time Prior To The Scheduled Booking. We Shall Be Entitled To Charge Cancellation Fees As Follows: If Cancelled Any Time But Not Later Than 2 Hours Prior To The Scheduled Booking, No Cancellation Fee Will Be Charged. If Cancelled After 2 Hours But Prior To 1 Hour Of Booking, Then X% Of Booking Fee Shall Be Deducted, And The Remaining Amount Will Be Refunded To The User. If Cancelled Within 1 Hour Of The Booking, The Full Booking Fee May Be Charged, And No Refund Will Be Provided. Refund Of Service Fee, In Case Of Cancellation Of Prepaid Orders: In Case Of Cancellation Of Booking At Any Time Before The Arrival Of The Service Professional At The Designated Address/Location, SuStylo Shall Process A Full Refund Of The Service Fee Paid By The Client Through The Platform. The Said Refund Shall Be Reflected Within The Source Account From Which The Payment Is Made, Within 7 (“Seven”) Working Days From The Date Of Cancellation. SuStylo Reserves The Right To Charge You Or Deduct Applicable Taxes, If Any, Payable On Such Service Fees.
                            </p>
